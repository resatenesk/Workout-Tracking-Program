...
public class KullaniciGirisEkrani {
    ...
    public static StackPane getRoot() {
        ...
        rootGenel.getStylesheets().add(KullaniciGirisEkrani.class.getResource("/static/style.css").toExternalForm());
        bilesenler();
        try {
            ayarlamalar();
        } catch (Exception e) {
    ...
    public static void bilesenler() {
        ...
        infoImage = new Image(KullaniciGirisEkrani.class.getResource("/ICONS/info.png").toExternalForm());
        ...
        Image image = new Image(KullaniciGirisEkrani.class.getResourceAsStream("/ICONS/ikon1.png"));
        ...
        Image image2 = new Image(KullaniciGirisEkrani.class.getResourceAsStream("/ICONS/ekle.png"));
    ...
    public static void kullaniciKontrol() throws Exception {
        ...
        if (username.equals("") && password.equals("")) {
            ...
            dialogPane.getStylesheets().add(KullaniciGirisEkrani.class.getResource("/static/alertStyle.css").toExternalForm());
            alert.showAndWait();
        } else {
            ...
            try (Connection con = Database.connect()) {
                ...
                if (rs.next()) {
                    ...
                    dialogPane2.getStylesheets().add(KullaniciGirisEkrani.class.getResource("/static/alertStyle.css").toExternalForm());
                    alert2.showAndWait();
                }
